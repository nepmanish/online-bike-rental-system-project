      ...
      <table className='w-full border-collapse text-left text-sm text-gray-600'>
        ...
        <thead className='text-gray-500'>
          <tr>
            ...
            <th className='p3 font-medium max-md:hidden'>Date Range</th>
            <th className='p-3 font-medium'>Total</th>
            <th className='p3 font-medium max-md:hidden'>Payment</th>
          ...
          {bookings.map((booking,index) => (
            <tr key={index} className='border-t border-borderColor text-gray-500'>
              ...
              <td className='p-3 flex items-center gap-3'>
                <img src={booking.bike.image} alt="" className='h-12 w-12 rounded-md object-cover aspect-square' />
              ...
              <td className='p-3'>
                ...
                {booking.status === 'pending' ? (
                  <select value={booking.status} className='px-2 py-1.5 mt-1 text-gray-500 border border-gray-500 rounded-md outline-none'>
